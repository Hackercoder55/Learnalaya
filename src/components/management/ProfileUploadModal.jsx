...
const styles = {
  backdrop: { 
    ...
    background: 'rgba(0,0,0,.30)', zIndex: 9999,
    display: 'flex', alignItems: 'center', justifyContent: 'center'
  },
  modal: { 
    background: '#f8fbff', padding: '36px 30px', borderRadius: 15,
    boxShadow: '0 8px 28px rgba(38, 92, 181, 0.11)', width: '350px',
    fontFamily: 'inherit', border: '1px solid #e3ebfa'
  },
  title: { 
    fontWeight: 700, fontSize: '1.2rem', marginBottom: 20,
    color: '#1d3557', textAlign: 'center'
  },
  field: { marginBottom: 15 },
  label: { 
    fontWeight: 500, color: '#246bfd', fontSize: 15,
    marginBottom: 5, display: 'block'
  },
  fileInput: { 
    padding: '10px 0', border: '1px solid #bdd7fa',
    borderRadius: 7, background: '#fff', width: '100%',
    boxSizing: 'border-box'
  },
  loading: { color: '#2563eb', textAlign: 'center', margin: '15px 0' },
  error: { 
    color: '#d32f2f', background: '#fff9f9', padding: 8,
    borderRadius: 6, textAlign: 'center'
  },
  footer: { display: 'flex', justifyContent: 'flex-end', marginTop: 20 },

  // 🔥 FIXED HERE → removed duplicate "color"
  buttonRed: {
    background: '#f1f5fa',
    color: '#365175',
    border: 0,
